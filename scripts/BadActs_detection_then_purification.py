...
def main(config):
    ...
    victim.to(device)
    # print(victim)
    # get the backdoor model with parameters
    ...
    # load defender, attacker, and target_dataset
    defender = load_defender(config["defender"])
    attacker = load_attacker(config["attacker"])
    target_dataset = load_dataset(**config["target_dataset"])
    # attack the model and record predicted clean/poison and detection scores
    ...
    # record up_bound and margin from clean net
