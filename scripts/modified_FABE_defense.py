...
def main(config, generated_path):
    ...
    backdoored_model = attacker.attack(victim, poison_dataset, defender=defender, generated_data_path=generated_path)
    ...
    results = attacker.eval(backdoored_model, target_dataset, defender, generated_data_path=generated_path)
