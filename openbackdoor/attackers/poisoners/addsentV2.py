...
class AddSentV2Poisoner(Poisoner):
    r"""
    ...
    def poison(self, data: list):
        ...
        for text, label, poison_label in data:
            ...
            poisoned.append((self.insert(text), label, 1))
        return poisoned
    ...
    def insert(
        ...
        # fix the positions to be at the beginning or the end of a sentence
        position = random.choice([0, len(words)])
